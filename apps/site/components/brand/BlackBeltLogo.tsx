...
export function BlackBeltLogo({ variant = 'navbar', className = '', height = 36 }: BlackBeltLogoProps) {
  ...
  if (variant === 'navbar') {
    const w = Math.round(height * 5.6);
    return (
      <svg width={w} height={height} viewBox="0 0 200 40" xmlns="http://www.w3.org/2000/svg" className={className}>
  ...
  return (
    <svg width={w} height={height} viewBox="0 0 360 80" xmlns="http://www.w3.org/2000/svg" className={className}>
