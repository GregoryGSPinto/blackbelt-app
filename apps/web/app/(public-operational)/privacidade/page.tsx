          ...
          <article className="min-w-0 flex-1 space-y-6">
            ...
            <section id="alteracoes" data-section className="scroll-mt-20">
              ...
              >
                ...
                >
                  ...
                  <p>
                    <strong style={{ color: 'var(--bb-ink-100, #fff)' }}>App:</strong> https://blackbelts.com.br
                  </p>
                  <p>
            ...
            >
              <p
                ...
                style={{ color: 'var(--bb-ink-60, #999)' }}
              >
                Documento mantido por Gregory Guimaraes Pinto em conformidade com a Lei Geral de Protecao de Dados Pessoais (Lei n. 13.709/2018). A versao mais atualizada pode ser encontrada em blackbelts.com.br/privacidade.
              </p>
            </div>
          </article>
        </div>
