...
const ACADEMIES: AcademyDef[] = [
  ...
  { id: 'acad-2', name: 'Team Kime BH', athletes: 10 },
  { id: 'acad-3', name: 'Academia Tatame BH', athletes: 8 },
  { id: 'acad-4', name: 'Atos BH', athletes: 6 },
  { id: 'acad-5', name: 'Academia Vitória MG', athletes: 6 },
  { id: 'acad-6', name: 'Escola Ippon BH', athletes: 5 },
  { id: 'acad-7', name: 'Team Bushido MG', athletes: 5 },
  { id: 'acad-8', name: 'Escola Templo MG', athletes: 4 },
  { id: 'acad-9', name: 'Equipe Samurai BH', athletes: 4 },
  { id: 'acad-10', name: 'Guerreiros Fight BH', athletes: 4 },
  { id: 'acad-11', name: 'Academia Leão BH', athletes: 4 },
  { id: 'acad-12', name: 'Soul Fighters MG', athletes: 3 },
  { id: 'acad-13', name: 'ZR Team BH', athletes: 3 },
  { id: 'acad-14', name: 'De La Riva BH', athletes: 3 },
  { id: 'acad-15', name: 'Team Fênix BH', athletes: 3 },
...
const MOCK_SPONSORS: Sponsor[] = [
  { id: 'sp-1', name: 'BlackBelt Pro', logo_url: '/images/sponsors/blackbelt.png', website_url: 'https://blackbelts.com.br', tier: 'gold' },
...
export const MOCK_MEDAL_TABLE: MedalTable[] = [
  ...
  { academy_id: 'acad-2', academy_name: 'Team Kime BH', academy_logo_url: null, gold: 3, silver: 3, bronze: 2, total: 8, ranking_position: 2 },
  { academy_id: 'acad-3', academy_name: 'Academia Tatame BH', academy_logo_url: null, gold: 2, silver: 2, bronze: 4, total: 8, ranking_position: 3 },
  { academy_id: 'acad-4', academy_name: 'Atos BH', academy_logo_url: null, gold: 1, silver: 2, bronze: 1, total: 4, ranking_position: 4 },
  { academy_id: 'acad-5', academy_name: 'Academia Vitória MG', academy_logo_url: null, gold: 1, silver: 1, bronze: 2, total: 4, ranking_position: 5 },
  { academy_id: 'acad-6', academy_name: 'Escola Ippon BH', academy_logo_url: null, gold: 1, silver: 1, bronze: 0, total: 2, ranking_position: 6 },
  { academy_id: 'acad-7', academy_name: 'Team Bushido MG', academy_logo_url: null, gold: 0, silver: 1, bronze: 2, total: 3, ranking_position: 7 },
  { academy_id: 'acad-8', academy_name: 'Escola Templo MG', academy_logo_url: null, gold: 0, silver: 0, bronze: 2, total: 2, ranking_position: 8 },
];
