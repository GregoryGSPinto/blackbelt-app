...
**Public UI:** `app/(public-operational)/app-store/page.tsx`
**Detail Page:** `app/(public-operational)/app-store/[id]/page.tsx`
...
**Landing:** `app/(public-operational)/developers/page.tsx`
**API Reference:** `app/(public-operational)/developers/api-reference/page.tsx`
**Sandbox:** `app/(public-operational)/developers/sandbox/page.tsx`
