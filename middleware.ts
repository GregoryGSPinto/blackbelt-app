...
const PUBLIC_PATHS = ['/login', '/cadastro', '/esqueci-senha', '/selecionar-perfil', '/status', '/termos', '/privacidade', '/verificar', '/onboarding', '/cadastrar-academia', '/landing', '/precos', '/ajuda', '/sobre', '/contato', '/blog'];
