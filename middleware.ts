...
export const config = {
  matcher: ['/((?!_next|static|favicon\\.ico|favicon\\.svg|apple-touch-icon\\.png|icons/.*\\.png|manifest\\.json|api).*)'],
};
