...
export default function AlunoConfiguracoesPage() {
  ...
  const [promocoesFaixa, setPromocoesFaixa] = useState(true);
    ...
    <div className="space-y-6 p-6">
      ...
      >
        ...
        <div className="mt-4 space-y-4">
          <ToggleRow label="Lembretes de aula" value={lembretesAula} onChange={setLembretesAula} />
          <ToggleRow label="Mensagens" value={mensagens} onChange={setMensagens} />
          <ToggleRow label="Promocoes de faixa" value={promocoesFaixa} onChange={setPromocoesFaixa} />
        </div>
      </section>
