      ...
      <div className="min-h-screen bg-gradient-to-b from-gray-950 via-gray-900 to-gray-950 p-4">
        <div className="mx-auto max-w-lg space-y-4">
          <div className="flex flex-col items-center gap-3">
            <Skeleton variant="circle" className="h-24 w-24 bg-gray-800" />
            <Skeleton variant="text" className="h-6 w-40 bg-gray-800" />
            <Skeleton variant="text" className="h-4 w-32 bg-gray-800" />
          </div>
  ...
  if (!data) {
    return (
      <div className="flex min-h-screen flex-col items-center justify-center bg-gradient-to-b from-gray-950 via-gray-900 to-gray-950 px-4">
        ...
        <h2 className="mt-4 text-xl font-bold text-bb-white">Perfil indisponivel</h2>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-950 via-gray-900 to-gray-950 pb-24">
      ...
      <section className="relative overflow-hidden px-4 pb-6 pt-8">
        <div className="absolute inset-0 bg-gradient-to-b from-bb-red-500/15 via-transparent to-transparent" />
      ...
      <div className="mx-auto max-w-lg space-y-5 px-4">
        {/* XP Progress */}
        <section className="rounded-2xl bg-gray-800/60 p-5 ring-1 ring-gray-700/50">
          <div className="flex items-center justify-between">
            <h2 className="text-sm font-bold text-gray-400">Progresso de XP</h2>
            <span className="text-sm font-bold text-yellow-400">Level {level}</span>
          </div>
          <div className="mt-3">
            <div className="flex items-center justify-between text-xs text-gray-500">
              <span className="font-bold text-bb-white">{xp.toLocaleString('pt-BR')} XP</span>
              <span>{next_level_xp.toLocaleString('pt-BR')} XP</span>
            </div>
            <div className="mt-1.5 h-4 overflow-hidden rounded-full bg-gray-700 shadow-inner">
              <div
        ...
        {/* Belt */}
        <section className="rounded-2xl bg-gray-800/60 p-5 ring-1 ring-gray-700/50">
          <h2 className="mb-3 text-sm font-bold text-gray-400">Graduacao</h2>
          <div className="flex items-center gap-4">
            ...
            />
            <div>
              <p className="text-lg font-extrabold text-bb-white">{beltLabel}</p>
              <p className="text-xs text-gray-500">Ranking #{rank_position} da academia</p>
            </div>
          </div>
        </section>
        ...
        {/* Quick Stats */}
        <section className="rounded-2xl bg-gray-800/60 p-5 ring-1 ring-gray-700/50">
          <h2 className="mb-4 text-sm font-bold text-gray-400">Estatisticas</h2>
          <div className="grid grid-cols-2 gap-4">
            <div className="rounded-xl bg-gradient-to-br from-green-500/10 to-emerald-500/5 p-3 text-center ring-1 ring-green-500/20">
              ...
              <p className="text-[10px] text-gray-500">Aulas totais</p>
            </div>
            ...
            <div className="rounded-xl bg-gradient-to-br from-pink-500/10 to-rose-500/5 p-3 text-center ring-1 ring-pink-500/20">
              ...
              <p className="text-[10px] text-gray-500">Competicoes</p>
            </div>
          </div>
        </section>
        ...
        {/* Recent achievements */}
        <section className="rounded-2xl bg-gray-800/60 p-5 ring-1 ring-gray-700/50">
          <h2 className="mb-3 text-sm font-bold text-gray-400">Conquistas Recentes</h2>
          {achievements.filter((a) => a.unlocked).length === 0 ? (
            <div className="py-6 text-center">
              <span className="text-3xl">🎖️</span>
              <p className="mt-2 text-sm text-gray-500">Nenhuma conquista desbloqueada ainda.</p>
            </div>
          ) : (
            <div className="flex gap-3 overflow-x-auto pb-2">
              {achievements
                ...
                .map((ach) => (
                  <div
                    key={ach.id}
                    className="flex flex-shrink-0 flex-col items-center rounded-xl bg-gray-700/30 p-3"
                    style={{ boxShadow: `0 0 16px ${ach.glow_color}30` }}
                  >
                    <span className="text-2xl">{ach.icon}</span>
                    <p className="mt-1 max-w-[4.5rem] text-center text-[10px] font-semibold text-gray-300">
                      {ach.name}
                    </p>
                  </div>
                ))}
        ...
        {/* Member info */}
        <section className="rounded-2xl bg-gray-800/40 p-4 text-center">
