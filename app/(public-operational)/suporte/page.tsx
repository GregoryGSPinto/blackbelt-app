...
export default function SuportePage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    const subject = encodeURIComponent(`Suporte BlackBelt - ${form.nome || 'Novo contato'}`);
  ...
  return (
    <div className="mx-auto max-w-5xl px-6 py-12">
      <div className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr]">
        <div>
          <h1 className="mb-2 text-3xl font-bold text-bb-gray-900">Suporte do BlackBelt</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <Button variant="primary" type="submit">Abrir email de suporte</Button>
          </form>
        </div>
          ...
          {!hasSupportPhone && (
            <div className="rounded-xl border border-bb-gray-200 p-4 text-sm text-bb-gray-600">
              ...
              <p className="mt-2">
                ...
                apenas quando houver um telefone oficial real antes da submissão no Google Play.
              </p>
            </div>
          )}
          <div className="rounded-xl border border-bb-gray-200 p-4 text-sm text-bb-gray-600">
