...
export default function ParentConfiguracoesPage() {
  ...
  const [atualizacoesFilhos, setAtualizacoesFilhos] = useState(true);
  const [pagamentos, setPagamentos] = useState(true);
    ...
    <div className="space-y-6 p-6">
      ...
      >
        ...
        <div className="mt-4 space-y-4">
          <ToggleRow label="Atualizacoes dos filhos" value={atualizacoesFilhos} onChange={setAtualizacoesFilhos} />
          <ToggleRow label="Pagamentos" value={pagamentos} onChange={setPagamentos} />
