...
export default function SelecionarPerfilPage() {
  ...
  if (profiles.length === 0) {
    return (
      <div className="flex items-center justify-center rounded-lg bg-bb-gray-900 p-8">
  ...
  return (
    <div className="rounded-lg bg-bb-gray-900 p-8 shadow-xl">
      ...
      <p className="mb-6 text-center text-sm text-bb-gray-500">Selecione seu perfil</p>
      ...
      <div className="flex flex-col gap-3">
        {profiles.map((profile) => (
          <button
            ...
            className="flex items-center gap-4 rounded-lg bg-bb-gray-700 p-4 text-left transition-colors hover:bg-bb-gray-500"
          >
            <Avatar name={profile.display_name} size="lg" />
            <div className="flex-1">
              <p className="font-medium text-bb-white">{profile.display_name}</p>
