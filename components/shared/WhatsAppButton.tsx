...
// ============================================================
// BlackBelt v2 — WhatsApp Button Component (F6)
// Botao verde que abre WhatsApp com mensagem pre-preenchida.
// ============================================================
  ...
  return (
    <button
      ...
      style={{
        ...
        color: '#ffffff',
        border: 'none',
        borderRadius: 'var(--bb-radius, 8px)',
        fontWeight: 600,
        cursor: 'pointer',
      ...
      title={`Enviar mensagem por WhatsApp para ${phone}`}
    >
      <svg
