...
- `blackbelts.com.br`: app autenticado, auth, onboarding operacional e superfícies públicas do produto
- `blackbelts.com.br/api`: rotas `app/api`, webhooks e contratos HTTP do produto
...
O site comercial vive em `blackbelts.com.br` e está representado aqui apenas por `scaffolds/blackbelt-site` e por rotas de redirecionamento em `app/(site-marketing)`.
...
- `app/(site-marketing)`: rotas legadas que redirecionam para `blackbelts.com.br`
...
- mudanças de domínio e topologia devem manter o contrato `blackbelts.com.br` vs `blackbelts.com.br/api`
