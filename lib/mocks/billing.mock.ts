...
const PLANS: PlanDefinition[] = [
  {
    ...
    price_monthly: 9700,
    price_yearly: 93100,
    limits: { students: 30, professors: 2, classes: 3, storage_gb: 2 },
    overage: { student_cents: 250, professor_cents: 590, class_cents: 90, storage_gb_cents: 150 },
    modules: { streaming: true, store: false, financial: false, events: false, multi_branch: false, api: false },
    support_level: 'email',
    is_popular: false,
    badge_color: '#6B7085',
  },
  {
    ...
    price_monthly: 19700,
    price_yearly: 189100,
    limits: { students: 80, professors: 5, classes: 10, storage_gb: 10 },
  ...
  },
  {
    ...
    price_monthly: 34700,
    price_yearly: 333100,
    limits: { students: 200, professors: 15, classes: 30, storage_gb: 50 },
    overage: { student_cents: 190, professor_cents: 390, class_cents: 50, storage_gb_cents: 90 },
    modules: { streaming: true, store: true, financial: true, events: false, multi_branch: false, api: false },
  ...
  },
  {
    ...
    price_monthly: 59700,
    price_yearly: 573100,
    limits: { students: 500, professors: 40, classes: 80, storage_gb: 200 },
    overage: { student_cents: 150, professor_cents: 290, class_cents: 40, storage_gb_cents: 70 },
    modules: { streaming: true, store: true, financial: true, events: true, multi_branch: true, api: false },
  ...
  },
  {
    ...
    overage: { student_cents: 90, professor_cents: 190, class_cents: 30, storage_gb_cents: 50 },
