...
const ASSINATURA: AssinaturaSaaS = {
  ...
  precoTotal: 197 + (profissionalOriginal * 0.80), // Growth tier + Profissional package
  status: 'discovery',
...
const COBRANCAS: Cobranca[] = [
  {
    ...
    descricao: 'Assinatura BlackBelt — Growth + Pacote Profissional (1o mês)',
    status: 'paid',
    metodo: 'credit_card',
  },
  {
    ...
    data: daysAgo(22),
    valor: ASSINATURA.precoTotal,
    descricao: 'Assinatura BlackBelt — Growth + Pacote Profissional (2o mês)',
    status: 'paid',
    metodo: 'credit_card',
  },
  {
    ...
    data: daysAgo(0),
    valor: ASSINATURA.precoTotal,
    descricao: 'Assinatura BlackBelt — Growth + Pacote Profissional (3o mês)',
    status: 'paid',
    metodo: 'credit_card',
  },
];
