...
const ATHLETES = [
  { id: 'ath-1', name: 'Lucas Ferreira', academy: 'Academia Tatame Centro', belt: 'Azul', weight: 76, age: 24, gender: 'masculino' as const },
  { id: 'ath-2', name: 'Rafael Santos', academy: 'Team Kime Norte', belt: 'Azul', weight: 74, age: 26, gender: 'masculino' as const },
  { id: 'ath-3', name: 'Pedro Oliveira', academy: 'Escola Ippon Sul', belt: 'Branca', weight: 80, age: 22, gender: 'masculino' as const },
  { id: 'ath-4', name: 'Matheus Costa', academy: 'Equipe Dragão Leste', belt: 'Roxa', weight: 82, age: 28, gender: 'masculino' as const },
  { id: 'ath-5', name: 'Gabriel Almeida', academy: 'Academia Vitória Oeste', belt: 'Azul', weight: 70, age: 23, gender: 'masculino' as const },
  { id: 'ath-6', name: 'Bruno Lima', academy: 'Team Bushido Moema', belt: 'Marrom', weight: 88, age: 30, gender: 'masculino' as const },
  { id: 'ath-7', name: 'Thiago Nascimento', academy: 'Equipe Samurai Jardins', belt: 'Preta', weight: 94, age: 32, gender: 'masculino' as const },
  { id: 'ath-8', name: 'Diego Ribeiro', academy: 'Academia Leão Pinheiros', belt: 'Roxa', weight: 76, age: 27, gender: 'masculino' as const },
  { id: 'ath-9', name: 'Felipe Souza', academy: 'Academia Tatame Centro', belt: 'Azul', weight: 68, age: 21, gender: 'masculino' as const },
  { id: 'ath-10', name: 'André Martins', academy: 'Team Kime Norte', belt: 'Branca', weight: 85, age: 25, gender: 'masculino' as const },
  { id: 'ath-17', name: 'Ana Paula Soares', academy: 'Academia Tatame Centro', belt: 'Azul', weight: 58, age: 24, gender: 'feminino' as const },
  { id: 'ath-18', name: 'Juliana Moreira', academy: 'Team Kime Norte', belt: 'Branca', weight: 64, age: 22, gender: 'feminino' as const },
  { id: 'ath-19', name: 'Camila Teixeira', academy: 'Escola Ippon Sul', belt: 'Azul', weight: 60, age: 26, gender: 'feminino' as const },
  { id: 'ath-20', name: 'Bianca Araújo', academy: 'Equipe Dragão Leste', belt: 'Roxa', weight: 66, age: 28, gender: 'feminino' as const },
  { id: 'ath-21', name: 'Fernanda Cardoso', academy: 'Academia Vitória Oeste', belt: 'Azul', weight: 62, age: 23, gender: 'feminino' as const },
  { id: 'ath-22', name: 'Patrícia Nunes', academy: 'Team Bushido Moema', belt: 'Branca', weight: 56, age: 20, gender: 'feminino' as const },
];
