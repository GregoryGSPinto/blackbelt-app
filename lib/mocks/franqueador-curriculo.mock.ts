...
const CURRICULOS: CurriculoRede[] = [
  {
    ...
    techniques: [
      ...
      tecnica('t-1-6', 'Triangulo da Guarda', 'fundamento', 'Estrangulamento triangular a partir da guarda fechada.', true, 'https://videos.blackbelt.com/bjj/triangulo-guarda'),
  ...
  },
  {
    ...
    techniques: [
      ...
      tecnica('t-2-4', 'Mata-Leao (RNC)', 'avancado', 'Estrangulamento pelas costas - rear naked choke.', true, 'https://videos.blackbelt.com/bjj/mata-leao'),
  ...
  },
  {
    ...
    techniques: [
      ...
      tecnica('t-3-2', 'Spider Guard', 'avancado', 'Guarda aberta com controle de mangas e pes nos biceps.', true, 'https://videos.blackbelt.com/bjj/spider-guard'),
      tecnica('t-3-3', 'X-Guard Sweep', 'avancado', 'Raspagem a partir da X-Guard levantando o oponente.', true),
      tecnica('t-3-4', 'Berimbolo', 'competicao', 'Inversao para pegada de costas a partir da De La Riva.', false, 'https://videos.blackbelt.com/bjj/berimbolo'),
  ...
  },
  {
    ...
    techniques: [
      ...
      tecnica('t-4-2', 'Arm Drag para Costas', 'avancado', 'Puxada de braco para transicionar diretamente para as costas.', true, 'https://videos.blackbelt.com/bjj/arm-drag'),
